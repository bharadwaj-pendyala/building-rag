import os
from .chunking import split_text_with_markdown_header
...
md_header_splits = split_text_with_markdown_header(
    markdown_document, headers_to_split_on=custom_headers
)
